...
private AsignaturaTableModel model;
public frmAsignatura(DAOmanager manager) throws DAOException{
initComponents();
this.manager = manager;
this.model = new AsignaturaTableModel(manager.getAsignaturaDAO());
...
this.Tabla.setModel(model);
    ...
    public static void main(String args[]) throws SQLException {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new frmAsignatura(manager).setVisible(true);
